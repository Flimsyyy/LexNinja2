...
public class ReaperFlameBlade()
    : LexNinja2Card(5, CardType.Power, CardRarity.Rare, TargetType.AllEnemies)
{
    protected override IEnumerable<DynamicVar> CanonicalVars => [new PowerVar<ReaperFlame>(3)];
