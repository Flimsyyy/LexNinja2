...
public class TurbinePower : LexNinja2Power
{
    ...
    protected override IEnumerable<IHoverTip> AdditionalHoverTips =>
        [HoverTipFactory.FromKeyword(NinjaKeyword.Science), LexKela.HoverTip()];

    public override string CustomIconPath => "TurbinePower32.png".PowerImagePath();
